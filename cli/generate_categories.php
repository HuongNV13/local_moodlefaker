...
/**
 * CLI script to create course category.
 *
...
-h, --help            Print out this help
    --total           Total of course categories to generate

Example:
\$ sudo -u www-data /usr/bin/php local/moodlefaker/cli/generate_categories.php
...
if ($options['total']) {
    ...
    for ($i = 1; $i <= $options['total']; $i++) {
        ...
        echo PHP_EOL . 'Generated course category: ' . $catname . PHP_EOL;
    }
}
